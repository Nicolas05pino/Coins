...
print(f"{bcolors.WHITE}Monedas que más han subido en los últimos 30 minutos:\033[0m ", bcolors.OKGREEN + df2.head(5))
print(f"{bcolors.WHITE}Monedas que más han bajado en los últimos 30 minutos:\033[0m ", bcolors.FAIL + df1.head(5))
